                ...
                <div className="w-full flex flex-col gap-16 px-10">
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <p className="footer__desc-text">
                                    وقتی تازه شروع به یادگیری برنامه نویسی کردم. یکی از مشکلاتی که در فرآیند یادگیری
                                    داشتم، کمبود آموزش های خوب با پشتیبانی قابل قبول بود که باعث شد اون موقع تصمیم بگیرم
                                    اگر روزی توانایی مالی و فنی قابل قبولی داشتم یک وب سایت برای حل این مشکل راه اندازی
                                    کنم! و خب امروز آکادمی آموزش برنامه نویسی سبزلرن به عنوان یک آکادمی خصوصی فعالیت
                                    میکنه و این به این معنی هست که هر مدرسی اجازه تدریس در اون رو نداره و باید از
                                    فیلترینگ های خاص آکادمی سبزلرن رد شه! این به این معنی هست که ما برامون فن بیان و
                                    نحوه تعامل مدرس با دانشجو بسیار مهمه! ما در آکادمی سبزلرن تضمین پشتیبانی خوب و با
                                    کیفیت رو به شما میدیم . چرا که مدرسین وب سایت سبزلرن حتی برای پشتیبانی دوره های
                                    رایگان شون هم هزینه دریافت میکنند و متعهد هستند که هوای کاربر های عزیز رو داشته
                                    باشند
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-12 gap-10">
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <div className="footer__widget-item">
                                            <NavLink className="flex items-center" href="#">
                                                فروشگاه
                                    ...
                                    <div className="col-6">
                                        ...
                                        <div className="footer__widget-item">
                                            <NavLink className="footer-widget__link flex items-center" href="#">
                                                پایتون
                            ...
                            <div className="col-span-8 md:col-span-3  footer-widget__contact-us">
                                ...
                                <div className="footer-widget__text">
                                    ...
                                    <div className="flex gap-5">
                                        <span className="footer-widget-phone-name">شماره همراه</span>
                                        <span className="footer-widget-phone-number">09396007232</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex items-end justify-center footer__copyright">
                        <p className="text-sm flex items-center">
                            ...
                            <NavLink href="https://sabzlearn.ir/" className="footer__link hpc__popular !text-lg">
                                سبزلرن
                            </NavLink>
                            میباشد
                        </p>
