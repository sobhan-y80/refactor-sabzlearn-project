                            ...
                            <g id="style=doutone">
                              <g id="lock-circle">
                                ...
                                <path
                                  ...
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M1.25 13C1.25 9.82436 3.82436 7.25 7 7.25H17C20.1756 7.25 22.75 9.82436 22.75 13V17C22.75 20.1756 20.1756 22.75 17 22.75H7C3.82436 22.75 1.25 20.1756 1.25 17V13ZM7 8.75C4.65279 8.75 2.75 10.6528 2.75 13V17C2.75 19.3472 4.65279 21.25 7 21.25H17C19.3472 21.25 21.25 19.3472 21.25 17V13C21.25 10.6528 19.3472 8.75 17 8.75H7Z"
                                  fill="#43c67a"
                                />
                                <path
                                  id="vector (Stroke)_3"
                                  fillRule="evenodd"
                                  clipRule="evenodd"
                                  d="M12 13.75C11.3096 13.75 10.75 14.3096 10.75 15C10.75 15.6904 11.3096 16.25 12 16.25C12.6904 16.25 13.25 15.6904 13.25 15C13.25 14.3096 12.6904 13.75 12 13.75ZM9.25 15C9.25 13.4812 10.4812 12.25 12 12.25C13.5188 12.25 14.75 13.4812 14.75 15C14.75 16.5188 13.5188 17.75 12 17.75C10.4812 17.75 9.25 16.5188 9.25 15Z"
                                  fill="#B3E8C9"
                                />
                              </g>
                            </g>
