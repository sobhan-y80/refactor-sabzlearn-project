...
function Main() {
  ...
  const [formState, onInputHandler] = useForm(
    {
      name: {
        value: mainUserDataInfo.name,
        isValid: true,
      },
      username: {
        value: mainUserDataInfo.username,
        isValid: true,
      },
      email: {
        value: mainUserDataInfo.email,
        isValid: true,
      },
      phoneNumber: {
        value: mainUserDataInfo.phone,
        isValid: true,
      },
    },
    false
  ...
  return (
    <>
      <div className="panel-home__header">
        <h2 className="panel-home__header-title">بررسی اجمالی</h2>
        <h3 className="panel-home__header-time-update info-timezone">
          این ماه
        </h3>
      </div>
      <div className="panel-home__info-box-wrapper">
        <div className="grid grid-cols-12 gap-5">
          <div className="col-span-12 md:col-span-4 my-3 md:my-0">
            <div className="panel-home__info-box">
              <div className="info-box__right">
                <div className="info-box__title">درآمد</div>
                <div className="info-box__desc">
                  <div className="info-box__income-content">
                    <span className="info-box__income-symbol info-box__symbol">
                      $
                    </span>
                    <span className="info-box__income-number info-box__number">
                      2,420
                    </span>
                  </div>
                  <div className="info-box__profit-content">
                    <span className="info-box__profit-symbol info-box__symbol">
                      %
                    </span>
                    <span className="info-box__profit-numebr info-box__number">
                      5.2
                    </span>
                  </div>
                </div>
                <div className="info-box__time-update-content info-timezone">
                  <span className="info-box___title-name mx-1">درآمد</span>
                  <span className="info-box__time-update-name mx-1">
                    این ماه
                  </span>
                </div>
              </div>
              <div className="info-box__left">
                <div className="info-box__icon-wrapper">
                  <img
                    className="info-box__icon"
                    src="../images/panel/main-page/dollar.svg"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-span-12 md:col-span-4 my-3 md:my-0">
            <div className="panel-home__info-box">
              <div className="info-box__right">
                <div className="info-box__title">فروش</div>
                <div className="info-box__desc">
                  <div className="info-box__income-content">
                    <span className="info-box__income-symbol info-box__symbol">
                      $
                ...
                <div className="info-box__time-update-content info-timezone">
                  <span className="info-box___title-name">فروش</span>
                  <span className="info-box__time-update-name">این ماه</span>
                </div>
              </div>
              <div className="info-box__left">
                <div className="info-box__icon-wrapper">
                  <img
                    className="info-box__icon"
                    src="../images/panel/main-page/cashier.svg"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-span-12 md:col-span-4 my-3 md:my-0">
            <div className="panel-home__info-box">
              <div className="info-box__right">
                <div className="info-box__title">هزینه</div>
                <div className="info-box__desc">
                  <div className="info-box__income-content">
                    <span className="info-box__income-symbol info-box__symbol">
                      $
                ...
                <div className="info-box__time-update-content info-timezone">
                  <span className="info-box___title-name">هزینه</span>
                  <span className="info-box__time-update-name">این ماه</span>
                </div>
              </div>
              <div className="info-box__left">
                <div className="info-box__icon-wrapper">
                  <img
                    className="info-box__icon"
                    src="../images/panel/main-page/invoice-dollar.svg"
                    alt=""
                  />
                </div>
              </div>
      ...
      <div className="panel-home__chart hpc__part-section">
        <h3 className="hpc__title">فروش ماهانه</h3>
        <div className="panel-home-content-chart">
          <Chart
            title="فروش ماهانه"
            data={xAsisData}
            dataKey="name"
      ...
      <div className="panel-home__last-users hpc__custom-scroll hpc__part-section">
        <div className="panel-home__last-users__title">
          <span>
            افراد ثبت نام شده <span className="hpc__title">امروز</span>
          </span>
        </div>
        <div className="overflow-x-auto">
          <table className="tabel w-full min-w-max table-auto text-center">
            ...
            <tbody>
              {lastUsers.slice(0, 10).map((user, index) => {
                return (
                  <tr key={user._id}>
                    <td>{index + 1}</td>
                    <td>{user.name}</td>
